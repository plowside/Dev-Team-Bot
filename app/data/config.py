...
req_questions = {
	'order': {
		'programming': {
			'development_reason': {
				'q': 'Разработка:',
				'user_q': '<b>Что необходимо разработать?</b>\n\n<i>♦️ Напишите что нужно разработать или выберите один из предложенных вариантов.</i>',
				'skipable': False,
				'is_file': False,
				'inline_kb': [
			...
			'programming_language': {
				...
				'user_q': '<b>Какой язык программирования необходимо использовать?</b>\n\n<i>♦️ Напишите используемые языки программирования или выберите один из предложенных вариантов.</i>',
				'skipable': True,
				'is_file': False,
				'inline_kb': [
			...
			'deadline': {
				...
				'user_q': '<b>Сроки выполнения заказа?</b>\n\n<i>♦️ Напишите желаемые сроки выполнения или выберите один из предложенных вариантов.</i>',
				'skipable': True,
				'is_file': False,
				'inline_kb': [
			...
			'examples': {
				'q': 'Примеры:',
				'user_q': '<b>Примеры работ, которые Вам нужны</b>\n\n<i>♦️ Пришлите примеры работ или выберите один из предложенных вариантов.</i>',
				'skipable': True,
				'is_file': True,
				'reply_kb': []
			},
			'budget': {
				'q': 'Бюджет:',
				'user_q': '<b>Бюджет на разработку</b>\n\n<i>♦️ Напишите свой бюджет или выберите один из предложенных вариантов.</i>',
				'skipable': False,
				'is_file': False,
				'inline_kb': [
			...
			'technical_specification': {
				...
				'user_q': '<b>Техническое задание</b>\n\n<i>♦️ Пришлите нам техническое задание для вашего проекта.</i>',
				'skipable': False,
				'is_file': True,
				'reply_kb': []
			}
